...
print("Your plane's weaknesses are", weaknesses,"...be careful, pilot!") #this should be automatic. like a database within a program that would match fromer and later parameters to this one and tell YOU the weaknesses. 
